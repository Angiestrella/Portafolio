...
const cloudinaryVideos = {
  ...
  sommy: {
    1: 'https://res.cloudinary.com/lhqknncj/video/upload/v1788749177/1.mp4',
    2: 'https://res.cloudinary.com/lhqknncj/video/upload/v1788749188/2.mp4',
    3: 'https://res.cloudinary.com/lhqknncj/video/upload/v1788749183/3.mp4',
    4: 'https://res.cloudinary.com/lhqknncj/video/upload/v1788749189/4.mp4',
    5: 'https://res.cloudinary.com/lhqknncj/video/upload/v1788749203/5.mp4',
    7: 'https://res.cloudinary.com/lhqknncj/video/upload/v1788749186/7.mp4'
  }
};
      ...
      <div className="sommy-image-only">
        ...
        {[1, 2, 3, 4, 5, 7].map((videoNumber) => (
          <video
            ...
            key={videoNumber}
            src={cloudinaryVideos.sommy[videoNumber]}
